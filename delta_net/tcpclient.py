...
from delta_net.concurrent import Future, future_add_done_callback
...
from delta_net.gen import TimeoutError
...
class TCPClient(object):
    ...
    async def connect(
        ...
        of delta_net as this depends very much on the platform.
