...
from delta_net.concurrent import dummy_executor, run_on_executor
from delta_net.ioloop import IOLoop
from delta_net.util import Configurable, errno_from_exception
...
class Resolver(Configurable):
    ...
    class method::
        ...
        Resolver.configure('delta_net.netutil.ThreadedResolver')

    The implementations of this interface included with delta_net are

    * `delta_net.netutil.DefaultLoopResolver`
    * `delta_net.netutil.DefaultExecutorResolver` (deprecated)
    * `delta_net.netutil.BlockingResolver` (deprecated)
    * `delta_net.netutil.ThreadedResolver` (deprecated)
    * `delta_net.netutil.OverrideResolver`
    * `delta_net.platform.twisted.TwistedResolver` (deprecated)
    * `delta_net.platform.caresresolver.CaresResolver` (deprecated)
...
def ssl_wrap_socket(
    ...
    **kwargs: Any
    ...
    if ssl.HAS_SNI:
        ...
        # python3 -m delta_net.httpclient https://sni.velox.ch
