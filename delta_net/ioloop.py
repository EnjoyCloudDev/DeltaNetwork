...
from delta_net.util import Configurable, TimeoutError, import_object
...
class IOLoop(Configurable):
    ...
    As of delta_net 6.0, `IOLoop` is a wrapper around the `asyncio` event loop.
    ...
    .. testcode::
        ...
        import delta_net.ioloop
        from delta_net.iostream import IOStream
        ...
        def connection_ready(sock, fd, events):
            while True:
                ...
                io_loop = delta_net.ioloop.IOLoop.current()
    ...
    without the ``make_current=False`` argument is deprecated since delta_net 6.2.
    ...
    `delta_net.process` and `multiprocessing` modules) should do so as early as
    ...
    def configure(
        ...
        from delta_net.platform.asyncio import BaseAsyncIOLoop
    ...
    def instance() -> "IOLoop":
        ...
        .. versionchanged:: 5.0
           ...
           (when they differed, it was generally used from non-delta_net
    ...
    def make_current(self) -> None:
        ...
        .. deprecated:: 6.2
           ...
           3.10. All related functionality in delta_net is also
    ...
    def configurable_default(cls) -> Type[Configurable]:
        from delta_net.platform.asyncio import AsyncIOLoop
    ...
    def run_sync(self, func: Callable, timeout: Optional[float] = None) -> Any:
        ...
        .. versionchanged:: 6.2
           ``delta_net.util.TimeoutError`` is now an alias to ``asyncio.TimeoutError``.
        """
        ...
        def run() -> None:
            try:
                ...
                if result is not None:
                    from delta_net.gen import convert_yielded
    ...
    def add_timeout(
        ...
        **kwargs: Any
        ...
        current time.  Since delta_net 4.0, `call_later` is a more
        ...
        subclasses that wish to maintain compatibility with delta_net
    ...
    def spawn_callback(self, callback: Callable, *args: Any, **kwargs: Any) -> None:
        ...
        As of delta_net 6.0, this method is equivalent to `add_callback`.
    ...
    def add_future(
        ...
        awaitables (unlike most of delta_net where the two are
        interchangeable).
        """
        if isinstance(future, Future):
            # Note that we specifically do not want the inline behavior of
            # delta_net.concurrent.future_add_done_callback. We always want
            ...
            # the error logging (i.e. it goes to delta_net.log.app_log
        ...
        *args: Any
        ...
        if executor is None:
            if not hasattr(self, "_executor"):
                from delta_net.process import cpu_count
        ...
        # delta_net Future instead, using self.add_future for thread-safety.
...
class PeriodicCallback(object):
    ...
    milliseconds, while most other time-related functions in delta_net use
    ...
    def _update_next(self, current_time: float) -> None:
        ...
        if self._next_timeout <= current_time:
            ...
            # time.monotonic().
            # https://github.com/delta_netweb/delta_net/issues/2333
