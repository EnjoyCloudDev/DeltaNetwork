...
class Queue(Generic[_T]):
    ...
    def put(
        ...
        Returns a Future, which raises `delta_net.util.TimeoutError` after a
        timeout.

        ``timeout`` may be a number denoting a time (on the same
        scale as `delta_net.ioloop.IOLoop.time`, normally `time.time`), or a
    ...
    def get(
        ...
        `delta_net.util.TimeoutError` after a timeout.
        ...
        .. note::
           ...
           with other timeouts in delta_net).
    ...
    def join(
        ...
        Returns an awaitable, which raises `delta_net.util.TimeoutError` after a
        timeout.
        """
...
class PriorityQueue(Queue):
    ...
    .. testcode::
        ...
        import asyncio
        from delta_net.queues import PriorityQueue
...
class LifoQueue(Queue):
    ...
    .. testcode::
        ...
        import asyncio
        from delta_net.queues import LifoQueue
