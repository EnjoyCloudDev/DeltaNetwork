...
from delta_net.escape import utf8, native_str
from delta_net import gen, httputil
...
class AsyncHTTPClient(Configurable):
    ...
    def configurable_default(cls) -> Type[Configurable]:
        from delta_net.simple_httpclient import SimpleAsyncHTTPClient
    ...
    def configure(
        ...
        Example::
           ...
           AsyncHTTPClient.configure("delta_net.curl_httpclient.CurlAsyncHTTPClient")
        """
...
class HTTPRequest(object):
    ...
    def __init__(
        ...
        :type headers: `~delta_net.httputil.HTTPHeaders` or `dict`
        ...
        :arg collections.abc.Callable body_producer: Callable used for
           ...
           encoding on requests.  New in delta_net 4.0
...
class HTTPResponse(object):
    ...
    * ``headers``: `delta_net.httputil.HTTPHeaders` object
...
class HTTPClientError(Exception):
    ...
    * ``response`` - `HTTPResponse` object, if any.
    ...
    .. versionchanged:: 5.1
       ...
       `delta_net.web.HTTPError`. The name ``delta_net.httpclient.HTTPError`` remains
       as an alias.
    """
