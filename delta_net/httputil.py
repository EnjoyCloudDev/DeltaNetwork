...
from delta_net.escape import native_str, parse_qs_bytes, utf8
from delta_net.log import gen_log
from delta_net.util import ObjectDict, unicode_type
...
class HTTPServerRequest(object):
    ...
    .. versionchanged:: 4.0
       Moved from ``delta_net.httpserver.HTTPRequest``.
    """
