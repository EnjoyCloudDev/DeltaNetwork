...
from delta_net.escape import _unicode, native_str
from delta_net.log import define_logging_options
from delta_net.util import basestring_type, exec_in
...
class OptionParser(object):
    ...
    Normally accessed via static functions in the `delta_net.options` module,
    ...
    def group_dict(self, group: str) -> Dict[str, Any]:
        ...
        Useful for copying options into Application settings::
            ...
            from delta_net.options import define, parse_command_line, options
    ...
    def parse_config_file(self, path: str, final: bool = True) -> None:
        ...
        .. note::
            ...
            `delta_net.options` is primarily a command-line library.
