...
from delta_net.netutil import ssl_wrap_socket, _client_ssl_defaults, _server_ssl_defaults
...
class BaseIOStream(object):
    ...
    def set_close_callback(self, callback: Optional[Callable[[], None]]) -> None:
        ...
        was not removed in delta_net 6.0.
        """
...
class IOStream(BaseIOStream):
    ...
    .. testcode::
        ...
        import delta_net.iostream
        import socket

        async def main():
            s = socket.socket(socket.AF_INET, socket.SOCK_STREAM, 0)
            stream = delta_net.iostream.IOStream(s)
    ...
    def write_to_fd(self, data: memoryview) -> int:
        try:
            ...
            # See https://github.com/delta_netweb/delta_net/pull/2008
            del data
...
class SSLIOStream(IOStream):
    ...
    def _do_ssl_handshake(self) -> None:
        ...
        try:
            ...
            # https://groups.google.com/forum/?fromgroups#!topic/python-delta_net/ApucKJat1_0
            # Errno 0 is also possible in some cases (nc -z).
            # https://github.com/delta_netweb/delta_net/issues/2504
