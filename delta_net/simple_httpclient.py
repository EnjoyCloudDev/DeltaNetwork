...
from delta_net import gen, version
from delta_net.httpclient import (
    HTTPResponse,
    HTTPError,
    AsyncHTTPClient,
    main,
...
from delta_net.http1connection import HTTP1Connection, HTTP1ConnectionParameters
...
class SimpleAsyncHTTPClient(AsyncHTTPClient):
    ...
    This class implements an HTTP 1.1 client on top of delta_net's IOStreams.
    ...
    async def run(self) -> None:
        try:
            ...
            if self.request.user_agent:
                ...
                self.request.headers["User-Agent"] = "delta_net/{}".format(version)
