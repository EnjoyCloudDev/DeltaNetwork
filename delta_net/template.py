...
from delta_net.util import ObjectDict, exec_in, unicode_type
...
class Template(object):
    ...
    def __init__(
        ...
        :arg delta_net.template.BaseLoader loader: the `~delta_net.template.BaseLoader` responsible
            for this template, used to resolve ``{% include %}`` and ``{% extend %}`` directives.
        :arg bool compress_whitespace: Deprecated since delta_net 4.3.
